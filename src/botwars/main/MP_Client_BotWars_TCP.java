...
public class MP_Client_BotWars_TCP extends BotWars {
...
//http://www.andengine.org/forums/development/body-settransform-t1150.html
	...
	public Scene onLoadScene() {
		 try {
				...
				Toast.makeText(MP_Client_BotWars_TCP.this, "UNKNOWN SERVER ADDRESS", 100).show();
			} catch (IOException e) {
				
				Toast.makeText(MP_Client_BotWars_TCP.this, "ERROR CREATING SOCKET", 100).show();
			}
