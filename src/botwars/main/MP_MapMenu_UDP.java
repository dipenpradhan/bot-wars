...
public class MP_MapMenu_UDP extends MapMenu{
	...
	private void makeIPDialog() {
		...
		Dialog ipDialog = new Dialog(MP_MapMenu_UDP.this);
		...
		edtx_ip.setOnKeyListener(new OnKeyListener() {
			...
			public boolean onKey(View v, int keyCode, KeyEvent event) {
				if ((event.getAction() == KeyEvent.ACTION_DOWN)
					...
					Intent openMP_BotWars_UDP = new Intent(MP_MapMenu_UDP.this, MP_Server_BotWars_UDP.class);
