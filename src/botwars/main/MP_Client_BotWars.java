 ...
 */
public class MP_Client_BotWars extends BaseGameActivity implements IPinchZoomDetectorListener,IOnSceneTouchListener,IScrollDetectorListener {
	// ===========================================================
	// Constants
	// ===========================================================
	...
	public void onLoadResources() {
		...
		loadMap();
		 ...
		 try {
				mSocket=new Socket(InetAddress.getByName("192.168.1.140"), 8000);
			...
			public void onUpdate(float pSecondsElapsed) {
				...
				if (reduceHealth && mHealthSprite != null && mPlayerSprite != null) {
					...
					if (Player_Max_Health <= 0) {
						...
						Intent StartIntent = new Intent(MP_Client_BotWars.this, StartMenu.class);
...
bulletCount++;
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK && event.getRepeatCount() == 0) {
			...
			Intent openStartMenu = new Intent(MP_Client_BotWars.this, StartMenu.class);
